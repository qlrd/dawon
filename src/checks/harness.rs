...
//!
//! Capture limit: `dawon_capture` reads in a loop until EOF or
//! until its 65 535-byte buffer is full.  Outputs larger than that
//! are silently truncated; all C00–C09 exercises produce far less
//! than that.
//!
